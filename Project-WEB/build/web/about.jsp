    ...
    <body>
        ...
        <section id="mainContainer">
            <div class="about" >
                ...
                <div style="margin-top:-20px;font-size:30px;color:#556B2F;">WANG STUDIO, TOP BAKESHOP IN HANOI.</div>
                <div style="margin-top:20px;font-family:Candara;padding-left:210px;width:800px;font-size:20px;color:#556B2F;line-height:2em;">Wang Studio is known for it’s elegant, colourful and delicious selection of freshly baked sweet treats
                    and beautifully detailed custom cakes. 
                    The daily menu consists of signature whole cakes, customised cakes and other 
